...
inline void  iftSetCursorPosition(iftGenericLinkedList* list, int index,iftGenericLinkedListNode* node){
...
inline void iftAppendElementInList(iftGenericLinkedList *list, void *element){
...
inline void iftPushBackElementInList(iftGenericLinkedList *list, void *element){
    iftAppendElementInList(list,element);
}
inline void iftPrependElementInList(iftGenericLinkedList *list, void *element){
...
inline void iftPushFrontElementInList(iftGenericLinkedList *list, void *element){
...
inline void* iftGetElementIngenericList(iftGenericLinkedList *list, size_t index){
...
inline void* iftGetValueInListIterator(iftGenericListIterator* iterator){
    return iterator->node->data;
}

inline void* iftGetNextValueInListIterator(iftGenericListIterator* iterator){
    void* data = iterator->node->data;
    iterator->node = iterator->node->next;
    return data;
}

inline void* iftGetPreviousValueInListIterator(iftGenericListIterator* iterator){
    void* data = iterator->node->data;
    iterator->node = iterator->node->previous;
    return data;
}

inline void* iftHasNextInListIterator(iftGenericListIterator* iterator){
