 ...
 * in the input image.
 */
iftImage *iftBorderImage(const iftImage *label, const char get_margins);
...
/**
 * @brief Conquer superpixels which size is less than <area> by the IFT using the gray/color features
