...
iftObjModelMeanArcWeight *iftCreateObjModelMeanArcWeightProb(const iftImage *grad_test_img, const iftLabeledSet *seeds, iftVector max_disp);
...
iftVector iftMSPSObjModel(const iftImage *grad_test_img, const iftLabeledSet *seeds, int n_scales, int stride, iftVector max_disp);
