...
typedef struct _iftSelectorRDS {
    iftDataSet *dataSet;
    bool destroyDataset;
...
void iftPrintSelectorInfoRDS(iftSelectorRDS* selectorRDS);
...
typedef struct _iftCommonActiveLearning {
...
void iftPreprocessSelectorRDS(iftCommonActiveLearning* activeLearning,
